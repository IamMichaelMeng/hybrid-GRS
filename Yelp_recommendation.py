...
from model.Yelp.GAT import main as GAT_main
from model.Yelp.SBGNN import main as SBGNN_main
from model.Yelp import SRGNN as SRGNN_main
from model.Yelp.NGCF import main as NGCF_main
...
if __name__=='__main__':
    ...
    #context_features = read_context_features('./datasets/Yelp/Yelp_context_features.txt')
    ...
    file = open('results/Yelp_result_'+timestamp+'.txt', mode = 'a')
