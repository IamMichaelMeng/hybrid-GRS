...
parser.add_argument('--epoch', type=int, default=1, help='the original number is 80,Epoch')
...
def load_data(dataset_name):
    train_edgelist = np.loadtxt('./datasets/Foursquare/Foursquare_training.txt', dtype=np.int32)
    val_edgelist = np.loadtxt('./datasets/Foursquare/Foursquare_validation.txt', dtype=np.int32)
    test_edgelist = np.loadtxt('./datasets/Foursquare/Foursquare_testing.txt', dtype=np.int32)
