...
parser.add_argument('--epoch', type=int, default=30, help='the original number is 80,Epoch')
...
DATA_EMB_DIC1 = {'Gowalla': (5628,31803),}
...
def load_data(dataset_name):
    train_edgelist = np.loadtxt('./datasets/Gowalla/Gowalla_training.txt', dtype=np.int32)
    val_edgelist = np.loadtxt('./datasets/Gowalla/Gowalla_validation.txt', dtype=np.int32)
    test_edgelist = np.loadtxt('./datasets/Gowalla/Gowalla_testing.txt', dtype=np.int32)
