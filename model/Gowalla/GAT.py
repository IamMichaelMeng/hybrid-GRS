...
def main():
    ...
    graph = create_graph('datasets/Gowalla/Gowalla_data_size.txt', 'datasets/Gowalla/Gowalla_social_relations.txt')
    ...
    np.savetxt('datasets/group/Gowalla_GAT_trained_user_features.txt', best_embedding)

    # aggregate user emb to get group emb
    group_emb = aggregate_user_embedding(node_influence, 'datasets/group/Gowalla_GAT_trained_user_features.txt')
    np.savetxt('datasets/group/Gowalla_group_emb.txt',  group_emb, fmt='%f')
