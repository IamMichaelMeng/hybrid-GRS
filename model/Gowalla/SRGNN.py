...
from utils.SRGNN_utils import build_graph, Data, split_validation
from sklearn.preprocessing import normalize
parser = argparse.ArgumentParser()
parser.add_argument('--dataset', default='Gowalla', help='dataset name:Gowalla')
parser.add_argument('--batchSize', type=int, default=100, help='input batch size')
parser.add_argument('--hiddenSize', type=int, default=9, help='the original number is 100,hidden state size')
parser.add_argument('--epoch', type=int, default=30, help='the original number is 30, the number of epochs to train for')
...
def main():
    ...
    for epoch in tqdm(range(0, opt.epoch)):
        ...
        if bad_counter >= opt.patience:
            break
    #print(f'best result is :\nRecall:{best_result[0]}\nRecal_Epoch:{best_epoch[0]}\nMMR:{best_result[1]}\nMMR_Epoch:{best_epoch[1]}')
    return model
